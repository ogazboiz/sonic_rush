...
// src/SonicRushActivityBased.sol
...
contract SonicRushActivityBased {
    ...
    // APY cap (100% = 10000 basis points)
    uint256 public constant APY_CAP_BPS = 10000;
    ...
    function createStream(address recipient, uint256 duration) external payable {
        ...
        // Distribute fees
        uint256 stakerShare = (fee * STAKER_SHARE_BPS) / 10000;
        uint256 ownerShare = (fee * OWNER_SHARE_BPS) / 10000;
    ...
    function calculateExcessFunds() public view returns (uint256) {
        ...
        if (totalAPY <= APY_CAP_BPS) return 0;
        
        // Calculate excess
        uint256 excessAPY = totalAPY - APY_CAP_BPS;
    ...
    function getRevenueSplit() external view returns (uint256, uint256) {
        return (STAKER_SHARE_BPS, OWNER_SHARE_BPS);
    }
    ...
    function getCurrentAPY() external view returns (uint256) {
        ...
        return totalAPY > APY_CAP_BPS ? APY_CAP_BPS : totalAPY;
    }
